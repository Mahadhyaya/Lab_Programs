...
set revr1 [new Agent/LossMonitor];
$ns attach-agent $n2 $revr1
$ns at 1.12 "$n2 join-group $revr1 $group";

set revr2 [new Agent/LossMonitor];
$ns attach-agent $n3 $revr2
$ns at 1.15 "$n3 join-group $revr2 $group";

set revr3 [new Agent/LossMonitor];
$ns attach-agent $n4 $revr3
$ns at 0.3 "$n4 join-group $revr3 $group";

$ns at 3.3 "$n4 leave-group $revr3 $group";
